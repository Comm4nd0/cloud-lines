...
prompt DOMAIN              "Primary domain (e.g. cloud-lines.com)"  "cloud-lines.com"
...
SECRET_KEY=${SECRET_KEY}
DEBUG=False
ALLOWED_HOSTS=*.${DOMAIN},${DOMAIN},${SERVER_IP}
...
remote "sed -i 's/DOMAIN_PLACEHOLDER/${DOMAIN}/g' ${APP_DIR}/nginx/default.conf"
